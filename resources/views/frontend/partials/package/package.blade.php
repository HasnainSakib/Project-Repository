      ...
      <div class="row">
        ...
        <div  class="col-lg-4 col-md-6">
            <div  class="ts-pricing-box">
              <div style="background-color: rgb(13, 63, 110)" class="ts-pricing-header" >
              ...
              <div class="plan-action">
                <a href="{{ route('order',['cus_id'=>$authID,'pack_id'=>$item->id]) }}" class="btn" style="background-color:rgb(43, 20, 113);color:azure">Order Now</a>
              </div>
              @else
              <div class="plan-action">
