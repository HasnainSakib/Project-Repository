...
@section('main')
 ...
 <form class="row g-3" action="{{route('package.create')}}" method="POST">
    ...
    <div class="col-md-6">
      ...
      <input type="number" class="form-control" name="pack_price" min="100" placeholder=" " id="inputEmail5">
    </div>
    <div class="col-md-6">
      <label for="inputPassword5" class="form-label">pack_amount</label>
      <input type="number" class="form-control" name="pack_amount"  min="0" id="inputPassword5">
    </div>
    <div class="col-12">
...
{{-- 
    <div class="col-12">
      <label for="inputAddress5" class="form-label">New Panel</label>
      <input type="text" class="form-control" name="pack_description" id="inputAddres5s" placeholder="pack description">
    </div> --}}
    {{-- <div class="col-md-6">
