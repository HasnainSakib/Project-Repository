<!-- ======= Header ======= -->
<header id="header" class="header fixed-top d-flex align-items-center" style="background-color: lightblue">

    <div class="d-flex align-items-center justify-content-between">
      <a href="{{ route('dashboard') }}" class="logo d-flex align-items-center">
        <img src="ui/admin/assets/img/logo.png" alt="">

        <span class="d-none d-lg-block">CRM <span style="color: rgb(234, 57, 7)">(Admin)</span></span>
        ...
        <ul class="d-flex align-items-center">
          ...
          <li class="nav-item dropdown pe-3">
            ...
            <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
              ...
              <div>
                <img src="{{ asset('10.jpg') }}" style="width: 60px" height=:50px alt="Check your code">
                </div>
