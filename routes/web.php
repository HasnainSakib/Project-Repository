 ...
 */
    ...
    Route::get('/customer-register',[AuthFrontController::class,'customerRegister'])->name('customerRegister');
    ...
    Route::group(['middleware'=>'customer'],function(){
        ...
        Route::get('/password-change',[AuthFrontController::class,'changePassword'])->name('changePassword');
        Route::put('/password-update',[AuthFrontController::class,'updatePassword'])->name('updatePassword');
